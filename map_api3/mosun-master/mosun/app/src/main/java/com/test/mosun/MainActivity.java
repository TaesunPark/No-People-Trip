...
import com.test.mosun.information.Fragment_GoogleMap;
            ...
            switch (menuItem.getItemId()) {
                case R.id.home:
                    ...
                    if (fragment_GoogleMap != null)
                        fragmentManager.beginTransaction().hide(fragment_GoogleMap).commit();
                ...
                case R.id.map:
                    if (fragment_GoogleMap == null) {
                        fragment_GoogleMap = fragment_GoogleMap.newInstance();
                        fragmentManager.beginTransaction().add(R.id.frame_container, fragment_GoogleMap, "map").commit();
                    }
                    if (fragment_Home != null)
                        fragmentManager.beginTransaction().detach(fragment_Home).commit();
                    if (fragment_GoogleMap != null)
                        fragmentManager.beginTransaction().show(fragment_GoogleMap).commit();
                    if (fragment_Stamp != null)
                        fragmentManager.beginTransaction().detach(fragment_Stamp).commit();
                    if (fragment_Reward != null)
                        fragmentManager.beginTransaction().detach(fragment_Reward).commit();
