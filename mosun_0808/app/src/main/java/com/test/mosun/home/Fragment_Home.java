...
////        ViewPager viewPager = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_pager, null);
//        viewPager.setAdapter(new ViewPagerAdapter(getChildFragmentManager()));
...
//
//        viewPager.setAdapter(new adapter((FragmentActivity)getActivity().getSupportFragmentManager()));
