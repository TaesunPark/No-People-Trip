...
StampAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        pridictNumber.setText("오늘 예상 관광객 약 : " + String.valueOf(item.getPridictionNumber()) + "명");
        todayNumber.setText("현재까지 관광객 약 :"+String.valueOf(item.getTodayNumber())+"명");
